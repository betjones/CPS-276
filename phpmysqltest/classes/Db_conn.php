...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'betjones';//this will be your WCC username
      $dbUsr = 'betjones';//this will be your WCC username
      $dbPass = 'ErHEkVQqkVkr';//this will be the password found in the video.
